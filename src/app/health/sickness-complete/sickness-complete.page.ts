...
@Component({
  ...
  templateUrl: './sickness-complete.page.html',
  styleUrls: ['./sickness-complete.page.scss'],
})
export class SicknessCompletePage implements OnInit {
  ...
  async loadData(){
    ...
    if(localStorage.getItem("completar-salud") !== undefined && localStorage.getItem("completar-salud-fecha") !== undefined){
      this.model.animal_codigo = localStorage.getItem("completar-salud")
      this.model.fecha = localStorage.getItem("completar-salud-fecha")
  ...
  async presentAlertPositivo() {
    ...
    this.evento.tipo_evento = 'salud'
    const modal = await this.modalCtrl.create({
      component: ModalEventPage,
      componentProps: {
        header: 'Se realizo un control de salud!',
        message: 'Es necesario realizar un chequeo de salud dentro de',
        eventos: this.evento
      },
