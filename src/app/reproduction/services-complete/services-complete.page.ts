...
@Component({
  selector: 'app-services-complete',
  templateUrl: './services-complete.page.html',
  styleUrls: ['./services-complete.page.scss'],
})
export class ServicesCompletePage implements OnInit {
  ...
  constructor(public modalCtrl: ModalController,private dbContext: DbcontextService, private insomnia: Insomnia,private alertCtrl: AlertController, public navCtrl: NavController) { }
  ...
  ngOnInit() {
    ...
    if(localStorage.getItem("completar-servicio") !== undefined && localStorage.getItem("completar-servicio-fecha") !== undefined){
      this.model.animal_inseminado = localStorage.getItem("completar-servicio")
      this.model.fecha = localStorage.getItem("completar-servicio-fecha")
