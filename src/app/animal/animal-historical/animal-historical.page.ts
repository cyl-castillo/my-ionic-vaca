...
export class AnimalHistoricalPage implements OnInit {
  ...
  //rows = [{fecha:"25-06-2020",leche:10,concentrado:5,peso:10},{fecha:"24-06-2020",leche:10,concentrado:5,peso:10},{fecha:"23-06-2020",leche:10,concentrado:5,peso:10}]
  rows_evento:Array<{
    fecha:any,
    tipo_evento: string,
  }> = []
  ...
  /*columns = [
    { prop: 'day', name: 'Dia', width: '20%' },
    { prop: 'milk', name: 'Leche', width: '25%'  },
    { prop: 'concentrated', name: 'Concentrado', width: '30%'  },
    { prop: 'weight', name: 'Peso (Kg)', width: '25'  }
  ];*/
  /*rows = [
    {
      day: '1',
  ...
  async search(){
    //this.cria = await this.dbContext.getElementByAttrTable("animal_codigo",this.animal_codigo, "animal")
